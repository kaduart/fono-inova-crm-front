...
export const Select = React.forwardRef((
    ...
    <select
        ref={ref}
        className="w-full p-3 py-2 px-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent bg-white transition-all duration-200
