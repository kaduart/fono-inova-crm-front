                    ...
                    <div className="space-y-4">
                        {event?.extendedProps?.paymentStatus && (
                            <div className="flex items-center gap-2 mt-2">
                                <span className="font-medium text-sm">Status Financeiro:</span>
                                <span className={`px-2 py-1 rounded-full text-xs font-semibold ${event.extendedProps.paymentStatus === 'paid'
